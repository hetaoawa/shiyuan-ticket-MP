...
class TenantIntegrationMigrationTest {
    @Test void v27CreatesUniqueTenantTypeAndFieldEncryptedStorage() throws Exception {
        String sql=Files.readString(Path.of("src/main/resources/db/migration/V27__create_tenant_integration.sql"));
